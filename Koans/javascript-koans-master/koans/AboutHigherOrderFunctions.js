...
describe("About Higher Order Functions", function () {
  ...
  it("should use chain() ... .value() to use multiple higher order functions", function() {
      var result = _([ [0, 1], 2 ]).chain()
                       .flatten() // [0,1,2] o comando flatten agrupa os arrays em um só
                       .map(function(x) { return x+1 } ) // [1,2,3] o map nessa função está 
                                                         //somando +1 em todos os elementos
                       .reduce(function (sum, x) { return sum + x }) //[1+2+3] o reduce soma todos eles
                       .value(); // 6 o value mostra o resultado
